...
//        setOnClick listener to the buttons as you do the intent to the different pages/activities
...
//        ===================================================
//        Below is an implicit intent. Jumping into action when the button (LearnMore) is clicked, it takes us to the default browser.
...
//        Load your ad
    ...
    // loading the ad part(Both the successful and failed ad loading are placed in-order)
